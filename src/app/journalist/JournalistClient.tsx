...
const JournalistPage: React.FC = () => {
  ...
  const fetchJournalistEntries = useCallback(async (pageNumber: number = 1, append: boolean = false) => {
    try {
      ...
      const response = await fetch(API_ENDPOINTS.JOURNALIST_LIST, {
        method: 'POST',
        cache: 'no-store',
        headers: {
  ...
  }, [fetchJournalistEntries, entries.length]);
  ...
  return (
    <>
      ...
      <div className="title-block-journalist for-lg">
        <h1 className="main-title-journalist">
          <img src="/assets/images/gstvjournalist.png" alt="GSTV Journalist" />
        </h1>
      </div>

      <div className="blogs-main-section-inner journalistpage">
        {/* Header for small screens */}
        <div className="blogs-head-bar first for-sm">
          <span className="blog-category">
            <img src="/assets/images/gstvjournalist.png" width="40%" alt="GSTV Journalist" />
          </span>
        ...
        <div className="blogs-head-bar first for-lg">
                ...
                entries.map((newsItem) => (
                  <div key={newsItem.id} className="col-lg-6">
                    <div className="blog-read-content custom-top-news hometopnews">
                      <Link href={`/journalistdetails/${newsItem.id}`} className="flexAlink" title={newsItem.name}>
                                ...
                                <div className="reading-time-blog" style={{float:'left'}}>
                                  ...
                                  <div className="custom-reading-time">
                                    <div className="reading-icon">
                                      <img src="/images/clock.webp" alt="gstv news" />
                                    </div>
                                    1 મિનિટ વાંચન સમય
                                  </div>
                                </div>
                      <ShareButtons
                        url={`${typeof window !== 'undefined' ? window.location.origin : ''}/journalistdetails/${newsItem.id}`}
                        ...
                        imageUrl={
                          newsItem.video
                            ...
                            : (newsItem.featureImage?.length > 0
